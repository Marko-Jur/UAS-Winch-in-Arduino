...
//PIN definitions:
#define inputCLK 26  //PIN 2 has interrupt
#define inputDT 25  //PIN 3 has interrupt
...
float GetFallSpeed()
{
  ...
  //Serial.println(stateDifference);

  // Get time
  currentTime = micros();       // Get time using this function

...
#define RCSWITCH 7 //Pin 7 for the RC enabling
...
const int MINRANGECONSTANT = -400; //Constant for minimum speedoutput from encoder
...
int maxExtraction = 40;
int minExtraction = 100; //60
